...
const showRecipe = async function() {
    try {
        ...
        const res = await fetch('https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604691c37cdc054bd016');
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${_iconsSvgDefault.default}.svg#icon-clock"></use>
            </svg>
          ...
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href="${_iconsSvgDefault.default}.svg#icon-users"></use>
            </svg>
          ...
          <button class="btn--round">
            <svg class="">
              <use href="${_iconsSvgDefault.default}.svg#icon-bookmark-fill"></use>
            </svg>
          </button>
        </div>
          ...
          ${recipe.ingredients.map((ing)=>{
            ...
            <li class="recipe__ingredient">
              <svg class="recipe__icon">
                <use href="${_iconsSvgDefault.default}.svg#icon-check"></use>
              </svg>
